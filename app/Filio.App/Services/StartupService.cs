...
public static class StartupService
{
    ...
    private const string ValueName = "Filio";
    ...
    /// כזה היה יכול לגרום ל-Filio לקרוס בכל הפעלה, לא רק כשל שקט בהגדרה אחת.
    /// </summary>
    public static void SetEnabled(bool enabled)
    {
        ...
        {
            // אין הרשאה לכתוב למפתח ה-Run (מדיניות ארגונית/תוכנת אבטחה) - Filio ימשיך
