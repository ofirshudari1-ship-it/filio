...
/// <summary>
/// חילוץ טקסט מתמונות (JPG/PNG) באמצעות מנוע OCR מקומי (Tesseract) - זה מה שמאפשר ל-FileFox
...
/// ה-exe - מותקנים אוטומטית עם FileFox. אם הם חסרים (למשל התקנה פגומה), OCR נכשל בשקט
