...
public class AppSettings
{
    ...
    public string RootOutputFolder { get; set; } = Environment.GetFolderPath(Environment.SpecialFolder.UserProfile) + "\\Documents\\FileFox";
    ...
    /// שהוא מתויק. קובץ שמזוהה כאיום נשאר במקומו המקורי ולא עובר תיוק. FileFox לא בונה
