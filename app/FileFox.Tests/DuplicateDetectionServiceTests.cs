...
{
    private readonly string _sandbox = Path.Combine(Path.GetTempPath(), "FileFoxDupTests_" + Guid.NewGuid().ToString("N"));
    ...
    public void Index_PersistsAcrossServiceInstances()
    {
        ...
        // מדמה הפעלה חדשה של FileFox - צריך לטעון את האינדקס השמור מהדיסק
